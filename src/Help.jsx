  ...
  return (
    <div>
      ...
      <Section id="calculator" title="Calculator">
        ...
        <Sub>The load</Sub>
        <P>
          Pick a round from the built-in catalog (~1,440 commercial loads across Remington, Winchester, Nosler, Barnes,
          Federal, Hornady, Weatherby, and Berger) — it fills muzzle velocity, ballistic coefficient, drag model, and bullet weight. Or type your
