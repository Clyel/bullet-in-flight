...
const CONTACT_EMAIL = "admin@ballisticnerd.com";
const MAILTO =
  ...
  return (
    <div>
      ...
      <Section id="calculator" title="Calculator">
        ...
        <Sub>The load</Sub>
        <P>
          Pick a round from the built-in catalog (~1,850 commercial loads across Remington, Winchester, Nosler, Norma, Barnes,
          Federal, Hornady, Weatherby, Berger, Browning, Lapua, and Sig Sauer) — it fills muzzle velocity, ballistic coefficient, drag model, and bullet weight. Or type your
