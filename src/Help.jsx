  ...
  return (
    <div>
      ...
      <Section id="calculator" title="Calculator">
        ...
        <Sub>The load</Sub>
        <P>
          Pick a round from the built-in catalog (~1,230 commercial loads across Remington, Winchester, Barnes,
          Federal, Hornady, and Weatherby) — it fills muzzle velocity, ballistic coefficient, drag model, and bullet weight. Or type your
